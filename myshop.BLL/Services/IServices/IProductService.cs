...
namespace myshop.BLL.Services.IServices
{
    public interface IProductService
    {
        ...
        public Task<ICollection<ProductDto>> GetArchievedProducts();
        ...
        public Task<(ICollection<ProductDto> items, int total)> GetFilteredAndSortedProducts(int? Pagenum, SortEnum? order, string SearchedText);
        public Task RestoreProduct(int ProductId);
